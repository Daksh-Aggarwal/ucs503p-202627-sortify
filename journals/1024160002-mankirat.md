...
# W4: Project Timeline Planning and Visual Identity

## Objective

The main goal for this week was to map out our project schedule and milestones using a Gantt chart, and help decide the initial visual identity for Sortify before we start development.

## Work Done

- I created the project Gantt chart to map out all five phases across the semester.
- Structured the weekly tasks for each team member so we have clear deadlines and deliverables.
- Coordinated with Daksh to integrate the timeline directly into our formal project proposal.
- Participated in finalizing the app's visual identity, including the primary color palette and logo concepts for Sortify.

## Outcome

- We finalized a complete semester development timeline and Gantt chart.
- The project proposal was updated to reflect our planned schedule.
- The team agreed on a consistent visual theme and design direction for the mobile frontend.

## What I Learned

- Breaking a project into weekly milestones makes large development goals feel much more manageable.
- Having a shared schedule early keeps everyone aligned on who is responsible for what.

# W5: Prototype Report Preparation

## Objective

This week, my main goal was to prepare the prototype stage report for Sortify. The report had to follow the required TIET report format and only include the features that are actually implemented in the current demo.

## Work Done

- I reviewed the current Sortify prototype and checked what has been implemented so far.
- I prepared the prototype report using the required LaTeX report format.
- I added the team details, project title, course information, and instructor name based on our existing project proposal.
- I documented the implemented demo features such as the mobile app screens, scan demo, waste guide, result screen, local history, profile settings, scripted assistant, feedback flow, and admin demo.
- I made sure not to include unimplemented features as completed work, such as the real backend, trained ML model, production database, or live AI assistant.
- I included the available project diagrams in the report, including the data flow, activity, use case, and ER diagrams.
- I also fixed formatting issues in the report such as large blank spaces, forced page breaks, oversized diagram placement, and red hyperlink boxes in the generated PDF.

## Outcome

By the end of the week, the prototype stage report was created in LaTeX and placed in the project report prototype stage folder. The report now gives a clearer summary of the current demo state and separates implemented features from future work.

## What I Learned

- I learned that a project report should describe the real implementation honestly instead of listing planned features as completed.
- I understood how LaTeX formatting choices like figure placement, page style, and hyperlink settings can affect the final PDF.
- I also learned that keeping diagrams close to the related explanation makes the report easier to read.
